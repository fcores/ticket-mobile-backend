...
print("\n" + "="*80)
print("LIMPIEZA AUTOMATICA DE TICKETS")
print("="*80 + "\n")
...
if total_antes == 0:
    ...
    # Eliminar todos los tickets sin confirmación
...
for user in User.objects.all():
    ...
    print(f"  - {user.email:30} | {role_label}")

print("\n[OK] Base de datos limpia - Lista para empezar desde cero!")
print("="*80 + "\n")
